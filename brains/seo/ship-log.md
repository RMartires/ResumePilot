...
Newest first. Cooldown is **14 days** per cluster, or until GSC lists the new canonical for the query — whichever is later.

| Date | Keyword | Canonical | Cluster | PR / commit | Research |
|------|---------|-----------|---------|-------------|----------|
| 2026-08-21 | are canva resumes ats friendly | `/guides/ats/canva-resume-ats` | `design-tools` | (PR pending) | `~/Documents/Canva_Resume_ATS_Research_20260821/` |
...
- `design-tools` — cooling until **2026-09-04**. Do not ship a second Canva/Figma/InDesign page, and do not treat navigational `canva resume builder` / `resume templates canva` as a new keyword.
...
## Aborted / do not treat as a new keyword win

| Date | Attempt | Why aborted |
|------|---------|-------------|
| 2026-08-17 | Re-picked `ats friendly resume template` and drafted `/templates` copy | Same cluster as yesterday’s format guide; GSC lag is not a new opportunity |
