...
export const COMPARISONS = comparisonSchema.array().parse([
  {
    ...
    verdict: "There is no objectively best free resume builder. ResumePilot is a free, open-source AI builder with unlimited AI writing, ATS checks, and PDF export. Jobscan currently advertises free builder downloads, Rezi limits its free resume and PDF allowance, and Resume Genius limits free builder export to TXT. Recheck each official page before committing because competitor plans change.",
    rows: [
      { feature: "ResumePilot", productA: "Free and open source; unlimited AI, ATS checks, scores, and PDF export", productB: "Integrated builder, tailoring, scoring, cover letters, and job tracking" },
    ...
    sections: [
      ...
      { heading: "Run a ten-minute export test", body: "Create one role and two bullets, export the allowed format, and inspect text selection, spacing, page breaks, and deletion controls. ResumePilot exports PDF without a paid plan. For other tools, review any upgrade prompt shown in the product. This small test reveals more than a long feature list and reduces the cost of moving your full history later." },
    ],
    limitations: [
      ...
      "Competitor free limits and prices can change after review; users should verify current export, renewal, privacy, and cancellation terms on those sites.",
    ],
    faqs: [
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: "Free builder", productA: "Free and open source; unlimited create, edit, AI, and PDF export", productB: "Official builder page says unlimited create, edit, and download are free" },
      ...
      { feature: "Paid capabilities", productA: "None — ResumePilot has no paid plan", productB: "Official pages identify advanced AI optimization as paid" },
    ...
    sections: [
      ...
      { heading: "Verify current price and export terms", body: "Jobscan’s official builder page currently says its core builder supports free unlimited creation and downloads while advanced AI tools are paid. ResumePilot is free and open source, with unlimited AI writing, ATS checks, and PDF export. Compare file formats, scan or AI allowances, renewal terms, cancellation, and data handling on the day you choose." },
    ],
    limitations: [
    ...
    faqs: [
      { question: "Is ResumePilot a replacement for Jobscan?", answer: "It may cover similar building and matching tasks, but the products emphasize different workflows. Compare them with your own resume and posting rather than assuming the same scanner depth or feature set." },
      ...
      { question: "Which one should I use for free resume downloads?", answer: "Jobscan currently states that its core builder allows unlimited free creation and downloads. ResumePilot is free and open source, with unlimited PDF export after you sign in to the editor." },
    ],
    lastReviewed: reviewed,
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: "Free plan", productA: "Free and open source; unlimited AI, ATS checks, scores, and PDF export", productB: "Official pricing says one resume, limited AI, and up to three PDF downloads" },
      { feature: "Paid model", productA: "None — ResumePilot has no paid plan", productB: "Official pricing lists monthly Pro and one-time Lifetime options" },
    ...
    sections: [
      ...
      { heading: "Understand the documented free limits", body: "Rezi’s official pricing currently states that its free plan supports one resume, limited AI tools, and three PDF downloads without a card. ResumePilot is free and open source, with unlimited AI writing, ATS checks, scores, and PDF export. Competitor limits and plan names can change after this review." },
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: "Free export", productA: "Unlimited PDF, JSON, and Markdown export at no charge", productB: "Official pricing lists TXT-only resume builder export under free access" },
      { feature: "Paid export", productA: "None — PDF export is included at no charge", productB: "Official pricing lists PDF and Word in trial and annual plans" },
    ...
    sections: [
      ...
      { heading: "Read renewal terms before checkout", body: "Resume Genius’s official pricing currently describes a low-cost 14-day trial that automatically renews at a recurring four-week price unless canceled, plus an annual option billed upfront. Terms can change, so read the checkout disclosure. ResumePilot has no paid plan, trial, or checkout." },
    ],
    limitations: [
      "ResumePilot offers a smaller template and editorial library than the long-established Resume Genius site.",
      "ResumePilot users must still verify generated content and exported formatting for every important application.",
    ],
    faqs: [
