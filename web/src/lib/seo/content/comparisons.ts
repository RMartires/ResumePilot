...
export const COMPARISONS = comparisonSchema.array().parse([
  {
    ...
    rows: [
      { feature: "ResumePilot", productA: "Free entry point; confirm current export and AI limits on pricing page", productB: "Integrated builder, tailoring, scoring, cover letters, and job tracking" },
    ...
    sections: [
      ...
      { heading: "Run a ten-minute export test", body: "Create one role and two bullets, export the allowed format, and inspect text selection, spacing, page breaks, and deletion controls. Then compare the upgrade prompt with the current pricing page. This small test reveals more than a long feature list and reduces the cost of moving your full history later." },
    ],
    limitations: [
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: "Paid capabilities", productA: "Confirm current AI and usage limits on ResumePilot pricing", productB: "Official pages identify advanced AI optimization as paid" },
    ...
    sections: [
      ...
      { heading: "Verify current price and export terms", body: "Jobscan’s official builder page currently says its core builder supports free unlimited creation and downloads while advanced AI tools are paid. ResumePilot’s limits should be checked on its live pricing and product screens. Compare file formats, scan or AI allowances, renewal terms, cancellation, and data handling on the day you choose." },
    ],
    limitations: [
    ...
    faqs: [
      ...
      { question: "Which one should I use for free resume downloads?", answer: "Jobscan currently states that its core builder allows unlimited free creation and downloads. ResumePilot also has a free entry point, but confirm its current export formats and limits on the live pricing screen before deciding." },
    ],
    lastReviewed: reviewed,
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: "Paid model", productA: "Verify current ResumePilot pricing and allowances", productB: "Official pricing lists monthly Pro and one-time Lifetime options" },
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: "Free export", productA: "Confirm current formats and limits on live pricing", productB: "Official pricing lists TXT-only resume builder export under free access" },
